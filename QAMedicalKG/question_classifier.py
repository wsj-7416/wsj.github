...
class QuestionClassifier:
    def __init__(self):
        ...
        #　特征词路径
        self.disease_path = os.path.join(cur_dir, 'F:/Jupyter/QAMedicalKG/dict/disease.txt')
        self.department_path = os.path.join(cur_dir, 'F:/Jupyter/QAMedicalKG/dict/department.txt')
        self.check_path = os.path.join(cur_dir, 'F:/Jupyter/QAMedicalKG/dict/check.txt')
        self.drug_path = os.path.join(cur_dir, 'F:/Jupyter/QAMedicalKG/dict/drug.txt')
        self.food_path = os.path.join(cur_dir, 'F:/Jupyter/QAMedicalKG/dict/food.txt')
        self.producer_path = os.path.join(cur_dir, 'F:/Jupyter/QAMedicalKG/dict/producer.txt')
        self.symptom_path = os.path.join(cur_dir, 'F:/Jupyter/QAMedicalKG/dict/symptom.txt')
        self.deny_path = os.path.join(cur_dir, 'F:/Jupyter/QAMedicalKG/dict/deny.txt')
        # 加载特征词
